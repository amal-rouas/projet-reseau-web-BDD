...
var setColor = function (color) {
	...
	jQuery('.tho-wide-layout-btn').click(function(){
		...
		jQuery('body').removeClass('boxed default pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');
		jQuery('.main-slider').removeClass('container');
		jQuery('.tho-bg-patern').css({'display':'none''use strict';
...
ltr.click(function() {
	"use strict";
	jQuery(this).addClass("tho-active-switcher-btn");
	rtl.removeClass("tho-active-switcher-btn");
	jQuery("html").attr("dir", "ltr");
	jQuery("#option_style").attr("href", "assets/css/kidz.css");
...
rtl.click(function() {
	"use strict";
	jQuery(this).addClass("tho-active-switcher-btn");
	ltr.removeClass("tho-active-switcher-btn");
	jQuery("html").attr("dir", "rtl");
	jQuery("#option_style").attr("href", "assets/css/kidz.rtl.css");
});
